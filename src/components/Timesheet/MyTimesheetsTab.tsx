...
const mockUser = { employeeId: 'GOLNIC', fullName: 'Nicholas Goldup', role: 'admin' };

const mockProjects = [
  { projectId: 1, projectCode: '21-0066', projectDescription: 'Edmonton EXPO SOLAR IPD' },
  { projectId: 2, projectCode: '22-0006', projectDescription: 'AltaPro Service Department' },
  { projectId: 3, projectCode: '24-0052', projectDescription: 'Grant MacEwan School' },
  { projectId: 4, projectCode: '21-0029', projectDescription: 'Edmonton EXPO IPD' },
];
...
const StatusBadge = ({ status }) => {
  const variants = {
    Draft: { variant: 'outline', className: 'border-gray-300 text-gray-700' },
    Submitted: { variant: 'secondary', className: 'bg-blue-100 text-blue-700 border-blue-200' },
...
const EntryDetailsDialog = ({ entry, open, onOpenChange }) => {
...
export default function MyTimesheet() {
  ...
  const statistics = useMemo(() => {
    const stats = filteredEntries.reduce((acc, entry) => {
      ...
      acc.entries += 1;
      return acc;
    }, { totalHours: 0, standardHours: 0, overtimeHours: 0, entries: 0 });
