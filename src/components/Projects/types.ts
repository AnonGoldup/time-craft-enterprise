...
export interface Project {
  ...
  code: string;
  name: string;
  status: 'OPEN' | 'COMPLETE' | 'BID_WIN' | 'BID_LOST' | 'BID';
  manager: string;
  category: string;
...
export type SortBy = 'number' | 'name' | 'manager';

export type FilterBy = 'all' | 'OPEN' | 'COMPLETE' | 'BID_WIN' | 'BID_LOST' | 'BID';
...
export const mockProjects: Project[] = [
  ...
  { id: '7', code: '006', name: 'Overhead Project Template', status: 'BID', manager: 'Not Assigned', category: 'Commercial', estimatedHours: 0, actualHours: 0 },
  { id: '8', code: '007', name: 'IPD Project Template', status: 'BID_WIN', manager: 'Not Assigned', category: 'Commercial', estimatedHours: 0, actualHours: 0 },
  { id: '9', code: '16-0020', name: 'Borden Park Pool', status: 'BID_LOST', manager: 'Drew Yeoman', category: 'Commercial', estimatedHours: 2, actualHours: 4080 },
];
